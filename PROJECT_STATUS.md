...
- [x] `horadus tasks finish` now re-checks current-head required CI after the review gate clears and reports red CI promptly instead of drifting into a later timeout path
