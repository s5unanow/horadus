...
Archived from `tasks/CURRENT_SPRINT.md` when closing Sprint 2 on 2026-03-02.
This file preserves full historical sprint detail.
...
- `TASK-080` Telegram Collector Task Wiring `[REQUIRES_HUMAN]` — Postponed at sprint close (2026-03-02); still tracked in `tasks/BACKLOG.md`
