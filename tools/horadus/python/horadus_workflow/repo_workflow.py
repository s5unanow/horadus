...
HIGH_RISK_PRE_PUSH_REVIEW_STATEMENTS: tuple[str, ...] = (
    ...
    (
        ...
        "review, follow that guidance. When the selected provider is "
        "unavailable and local automation is still desired, rerun with "
        "`--allow-provider-fallback`; if the local-review path remains "
        "unusable, request manual review early rather than waiting for the "
        "finish loop."
    ),
    (
