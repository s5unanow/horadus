...
**Acceptance Criteria**:
- [ ] pyasn1 is constrained and locked at 0.6.4 or newer so all three disclosed advisories clear.
- [ ] The dependency audit and canonical full local gate pass without an allowlist waiver.
