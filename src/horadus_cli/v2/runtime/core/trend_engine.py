...
Example Usage:
    >>> from src.horadus_cli.v2.runtime.core.trend_engine import TrendEngine, calculate_evidence_delta
    >>>
...
if TYPE_CHECKING:
    ...
    from src.horadus_cli.v2.runtime.storage.models import Trend, TrendEvidence
...
class TrendEngine:
    ...
    async def apply_log_odds_delta(
        ...
        *,
        ...
        from src.horadus_cli.v2.runtime.storage.models import Trend
    ...
    async def apply_evidence(
        ...
        """
        from src.horadus_cli.v2.runtime.storage.models import TrendEvidence
    ...
    async def apply_decay(
        ...
        from src.horadus_cli.v2.runtime.storage.models import Trend as TrendModel
    ...
    async def get_probability_at(
        ...
        from src.horadus_cli.v2.runtime.storage.models import TrendSnapshot
