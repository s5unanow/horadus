...
@pytest.mark.asyncio
async def test_run_tier2_canary_tracks_partial_matches_without_counting_failures(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    items = [
        _gold_item(item_id="a", tier2=_tier2_label(signal_type="economic", direction="neutral"))
    ]
