...
- Never invent signal names or directions. If a fact is escalatory, do not pair it with a de-escalatory catalog signal; instead choose the supported escalatory signal or leave the taxonomy tag out.
- For policy or market changes, classify the direct mechanism first (tax reductions, market access, price premiums, cost parity, housing costs, hotlines, demilitarized zones) before secondary outcomes such as export growth, broad diplomacy, or general demand.
