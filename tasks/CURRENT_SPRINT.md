...
- `TASK-233` and `TASK-234` are paired so horizon-aware trend variants and first-class uncertainty/momentum land coherently instead of as separate retrofits.
