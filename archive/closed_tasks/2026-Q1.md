...
Close the current sprint ledger, select the next focused task set from the live
backlog, and rewrite `tasks/CURRENT_SPRINT.md` so the repo starts Sprint 8 with
an explicit goal, active lane, and suggested sequence.

**Planning Gates**: Not Required -- narrow live-ledger reset and sprint planning update
**Files**: `tasks/CURRENT_SPRINT.md`, `tasks/BACKLOG.md`, `tasks/COMPLETED.md`

**Acceptance Criteria**:
- [ ] Sprint 7 is closed in the live ledgers without losing its completed-task record
- [ ] Sprint 8 is seeded with the selected next tasks and a dependency-aware suggested sequence
